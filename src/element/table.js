...
module.exports = require("@feb/vue-design/lib/utils/popup");
...
module.exports = require("@feb/vue-design/lib/utils/resize-event");
...
module.exports = require("@feb/vue-design/lib/tooltip");
...
module.exports = require("@feb/vue-design/lib/utils/scrollbar-width");
...
var external_throttle_debounce_ = __webpack_require__(48);

// EXTERNAL MODULE: external "@feb/vue-design/lib/utils/resize-event"
var resize_event_ = __webpack_require__(16);

// EXTERNAL MODULE: external "normalize-wheel"
var external_normalize_wheel_ = __webpack_require__(58);
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/utils/scrollbar-width"
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/tooltip"
var tooltip_ = __webpack_require__(33);
...
/* harmony default export */ var layout_observer = ({
	...
	methods: {
		onColumnsChange: function onColumnsChange(layout) {
			...
			var flag = false;
			var expendWidth = 0;
			var elClasses = this.$el.classList.value;
			var isHeader = elClasses.includes("el-table__header");
			for (var i = 0, j = cols.length; i < j; i++) {
				...
				if (column) {
					if (isHeader) {
						// 隐藏expend列的表头:
						// 遇到expend列，设置width为0，记录下expend的width
						if (column.type === "expand") {
							col.setAttribute("width", expendWidth);
							expendWidth = column.realWidth || column.width;
							flag = true;
						} else if (flag) {
							// expend的下一列
							col.setAttribute("width", (column.realWidth || column.width) + expendWidth);
							// 重置标识
							expendWidth = 0;
							flag = false;
						} else {
...
/* harmony default export */ var table_body = ({
	...
	methods: {
		...
		rowRender: function rowRender(row, $index, treeRowData) {
			...
			var displayStyle = display ? null : { display: "none" };
			return h(table_row, {
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/utils/popup"
...
var getKeysMap = function getKeysMap(array, rowKey) {
	var arrayMap = {};(array || []).forEach(function (row, index) {
