...
module.exports = require("@feb/vue-design/lib/progress");
                  ...
                  _c("span", { staticClass: "file-info" }, [
                    _c("span", { staticClass: "file-name" }, [
                      ...
                      _c("span", { staticClass: "size" }, [
                        _vm._v(_vm._s(_vm.formattedFileSize(file))),
                      ]),
                    ]),
                    file.status === "fail"
                      ? _c("span", { staticClass: "el-upload-list__fail" }, [
                          _c("i", { staticClass: "el-icon-info" }),
                          _c("span", { staticClass: "fail-text" }, [
                            _vm._v(_vm._s(_vm.t("el.upload.uploadFail"))),
                          ]),
                          _c(
                            "span",
                            {
                              ...
                              on: {
                                click: function ($event) {
                                  _vm.handleRetryUpload(file)
                                },
                              },
                            },
                            [_vm._v(_vm._s(_vm.t("el.upload.reUpload")))]
                          ),
                        ])
                      : _vm._e(),
                  ]),
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/progress"
var progress_ = __webpack_require__(47);
...
/* harmony default export */ var upload_listvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    formattedFileSize: function formattedFileSize(file) {
      ...
      if (fileSizeKB < 1) {
        ...
        return (fileSizeKB / 1024).toFixed(1) + 'M';
      } else {
        return (fileSizeKB / 1048576).toFixed(1) + 'G';
      }
    },
    handleRetryUpload: function handleRetryUpload(file) {
      // console.error(this.submit)
      this.retry && this.retry(file);
    }
  }
});
...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    retry: function retry(file) {
      var retryFile = this.uploadFiles.find(function (_) {
        return _.uid === file.uid;
      });
      retryFile.status = 'ready';
      this.submit();
    },
