...
module.exports = require("@feb/vue-design/lib/transitions/collapse-transition");
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/transitions/collapse-transition"
    ...
    NodeContent: {
      ...
      render: function render(h) {
        ...
        return parent.renderContent ? parent.renderContent.call(parent._renderProxy, h, { _self: tree.$vnode.context, node: node, data: data, store: store }) : tree.$scopedSlots.default ? tree.$scopedSlots.default({ node: node, data: data }) : h(
          ...
          [data.icon && h('i', { 'class': ['el-tree-node__icon', data.icon] }), node.label]
        );
      }
    }
  },
