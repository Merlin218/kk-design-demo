...
/* harmony default export */ var tabsvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var header = h(
      'div',
      { 'class': ['el-tabs__header', 'is-' + tabPosition, 'is-' + size + '}'] },
    ...
    return h(
      ...
      { 'class': (_ref2 = {
        ...
        }, _ref2['el-tabs--' + tabPosition] = true, _ref2['el-tabs--' + size] = true, _ref2['el-tabs--border-card'] = type === 'border-card', _ref2['el-tabs--button'] = type === 'button', _ref2) },
