...
module.exports = require("@feb/vue-design/lib/button-group");
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/button-group"
var button_group_ = __webpack_require__(39);
...
/* harmony default export */ var dropdownvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var handleMainButtonClick = function handleMainButtonClick(event) {
      _this5.$emit('click', event);
      hide();
    };

    var triggerElm = null;
    if (splitButton) {
      triggerElm = h('el-button-group', [this.$slots.default && h(
        'el-button',
        {
        ...
        { ref: 'trigger', attrs: { type: type, size: dropdownSize, disabled: disabled },
          'class': ['el-dropdown__caret-button', this.$slots.default ? '' : 'is-no-content'] },
        [this.$slots.right || h('span', ['\u66F4\u591A', h('i', { 'class': 'el-dropdown__icon el-icon-caret-bottom' })])]
      )]);
    } else {
