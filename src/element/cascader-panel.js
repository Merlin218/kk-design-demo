...
module.exports = require("@feb/vue-design/lib/radio");
...
// EXTERNAL MODULE: external "@feb/vue-design/lib/radio"
var radio_ = __webpack_require__(50);
...
/* harmony default export */ var cascader_panelvue_type_script_lang_js_ = ({
	...
	computed: {
		config: function config() {
			console.log("-DefaultProps-", _extends({}, DefaultProps));
